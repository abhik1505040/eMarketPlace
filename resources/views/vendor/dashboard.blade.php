                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-4 col-md-6">
                                  <a href="{{route('vendor.product.manage')}}" class="single-mini-card-item bg-light-gray">
                                      ...
                                      <h4 class="title">Product Inventory</h4>
                              ...
                              <div class="col-lg-4 col-md-6">
                                    <a href="{{route('vendor.orders')}}" class="single-mini-card-item bg-light-blue">
                                        <div class="bg-icon">
                                            <i class="fas fa-dollar-sign"></i>
                                        </div>
                                        <h4 class="title">Products Sold</h4>
                                        @php
                                            $count = 0 ;
                                            $rows = \App\Orderedproduct::where('shipping_status', 2)->where('vendor_id', Auth::guard('vendor')->user()->id)->get() ;
                                            foreach($rows as $row) {
                                        ...
                                        <div class="counterup"><span class="count">{{$count}}</span></div>
                                    </a>
                                </div>
