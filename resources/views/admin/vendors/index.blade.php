                      ...
                      <tr>
                          ...
                          <td>
                            @if ($vendor->approved == 0)
                              <a href="#" title="Accept Request" style="margin-right:5px" onclick="accept(event, {{$vendor->id}})"><i class="fa fa-check-circle text-success action-icon"></i></a>
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data == "success") {
            ...
            window.location.href = '{{route('admin.vendors.all')}}';
