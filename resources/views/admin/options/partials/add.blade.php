    ...
    <div class="modal-content">
      <form class="" action="{{route('admin.options.store')}}" method="post">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add Attribute values under <strong>{{$pa->name}}</strong></h5>
              ...
              <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-12 mb-10">
                     ...
                     <input type="text" value="" class="form-control" id="name" name="name" placeholder="Enter Attribute value" >
                  </div>
                  <div class="col-md-12 mb-10">
