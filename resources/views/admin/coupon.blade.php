              ...
              <div class="tile-body">
                 <form role="form" method="POST" action="{{route('admin.coupon.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group" id="minamount">
                       ...
                       <input type="text" name="minimum_amount" class="form-control input-lg" value="{{old('minimum_amount')}}" placeholder="Minimum Order Amount">
                       @if ($errors->has('minimum_amount'))
                         <span style="color:red;">{{$errors->first('minimum_amount')}}</span>
                       @endif
                    </div>
                    ...
                    <div class="form-actions">
                       <button type="submit" class="btn btn-primary btn-block btn-lg">Create Coupon</button>
                    </div>
                 </form>
              </div>
           </div>
